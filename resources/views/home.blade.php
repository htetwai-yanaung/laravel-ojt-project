    ...
    <div class="services_section layout_padding">
        <div class="container">
           ...
           <div class="services_section_2">
              <div class="row">
                 <div class="col-md-4">
                    <div><img src="{{url('asset/images/img-1.png') }}" class="services_img"></div>
                    <div class="btn_main"><a href="#">Rafting</a></div>
                 </div>
                 <div class="col-md-4">
                    <div><img src="{{url('asset/images/img-2.png') }}" class="services_img"></div>
                    <div class="btn_main active"><a href="#">Hiking</a></div>
                 </div>
                 <div class="col-md-4">
                    <div><img src="{{url('asset/images/img-3.png') }}" class="services_img"></div>
        ...
        <div class="container-fluid">
           <div class="row">
              ...
              <div class="col-md-6 padding_right_0">
                 <div><img src="{{url('asset/images/about-img.png') }}" class="about_img"></div>
              </div>
           </div>
        </div>
     </div>
     ...
     <div class="blog_section layout_padding">
        <div class="container">
           ...
           <div class="play_icon_main">
              <div class="play_icon"><a href="#"><img src="{{url('asset/images/play-icon.png') }}"></a></div>
           </div>
        </div>
     </div>
     <!-- blog section end -->
                       ...
                       <div class="client_main">
                          ...
                          <div class="box_right">
                             <div class="client_taital_left">
                                <div class="client_img"><img src="{{url('asset/images/client-img.png') }}"></div>
                                <div class="quick_icon"><img src="{{url('asset/images/quick-icon.png') }}"></div>
                             </div>
